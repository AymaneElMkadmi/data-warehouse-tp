...
TP2_Pentaho_Aymane.pdf
Nettoyage, transformation et intégration de données avec Pentaho Data Integration.

TP3_Cloud_Pipeline_Moderne_Aymane.pdf
Conception d’un pipeline cloud moderne pour l’ingestion et le traitement des données.

TP4_Data_Warehouse_Moderne_Aymane.pdf
Modélisation et mise en œuvre d’un Data Warehouse moderne adapté aux besoins décisionnels.
